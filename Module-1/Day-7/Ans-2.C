...
int main(int argc, char *argv[]) {
  ...
  if (argc != 3) {
    printf("Usage: %s C:\Users\MD SHOAIB AKHTAR\Desktop\Assessment\learning--2023\Module-1\Day7\text.txt C:\Users\MD SHOAIB AKHTAR\Desktop\Assessment\learning--2023\Module-1\Day7\text.txt\n", argv[0]);
    return 1;
  }
